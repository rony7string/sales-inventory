...
if ( ! function_exists('currency'))
{
	...
	function currency($val = '', $def = '')
	{
		...
		if ($currency_id = $CI->session->userdata('currency'))
		{
		} else
		{
		...
		$exchange_rate = $CI->db->get_where('currency_settings',
			array('currency_settings_id' => $currency_id))->row()->exchange_rate_def;
